...
function iribbon_widgets_init() {
    ...
    register_sidebar(array(
		...
		'before_widget' => '<div class="box_outer_container span4 %2$s"><div id="box1" class="iribbon-box">',
	...
	register_sidebar(array(
		...
		'before_widget' => '<div class="box_outer_container span4 %2$s"><div id="box2" class="iribbon-box">',
		'after_widget' => '<div class="ribbon-bottom"><div class="ribbon-shadow"></div><div class="ribbon-bottom-end"></div></div></div></div>',
		'before_title' => '<div class="ribbon-top"><div class="ribbon-top-end"></div><h3 class="box-widget-title">',
		'after_title' => '</h3><div class="ribbon-shadow"></div></div>',
	));
	register_sidebar(array(
		...
		'before_widget' => '<div class="box_outer_container span4 %2$s"><div id="box3" class="iribbon-box">',
		'after_widget' => '<div class="ribbon-bottom"><div class="ribbon-shadow"></div><div class="ribbon-bottom-end"></div></div></div></div>',
		'before_title' => '<div class="ribbon-top"><div class="ribbon-top-end"></div><h3 class="box-widget-title">',
		'after_title' => '</h3><div class="ribbon-shadow"></div></div>',
	));
...
new WPUpdatesThemeUpdater( 'http://wp-updates.com/api/1/theme', 100, basename( get_template_directory() ) );
