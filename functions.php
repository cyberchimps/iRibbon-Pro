...
function response_widgets_init() {
    ...
    register_sidebar(array(
		...
		'before_widget' => '<div class="box_outer_container span4"><div class="ribbon-top-end"></div><div id="box1" class="iribbon-box">',
		'after_widget' => '<div class="ribbon-bottom"></div><div class="ribbon-bottom-cut"></div></div><div class="ribbon-bottom-end"></div></div>',
		'before_title' => '<div class="ribbon-top-cut"></div><div class="ribbon-top"><h3 class="box-widget-title">',
		'after_title' => '</h3></div><div class="ribbon-shadow"></div>',
	));
	register_sidebar(array(
		'name' => 'Box Middle',
		'id' => 'box-middle',
		'description' => 'This is the middle widget of the three-box section',
		'before_widget' => '<div class="box_outer_container span4"><div class="ribbon-top-end"></div><div id="box2" class="iribbon-box">',
		'after_widget' => '<div class="ribbon-bottom"></div><div class="ribbon-bottom-cut"></div></div><div class="ribbon-bottom-end"></div></div>',
		'before_title' => '<div class="ribbon-top-cut"></div><div class="ribbon-top"><h3 class="box-widget-title">',
		'after_title' => '</h3></div><div class="ribbon-shadow"></div>',
	));
	register_sidebar(array(
		...
		'before_widget' => '<div class="box_outer_container span4"><div class="ribbon-top-end"></div><div id="box3" class="iribbon-box">',
		'after_widget' => '<div class="ribbon-bottom"></div><div class="ribbon-bottom-cut"></div></div><div class="ribbon-bottom-end"></div></div>',
		'before_title' => '<div class="ribbon-top-cut"></div><div class="ribbon-top"><h3 class="box-widget-title">',
		'after_title' => '</h3></div><div class="ribbon-shadow"></div>',
	));
